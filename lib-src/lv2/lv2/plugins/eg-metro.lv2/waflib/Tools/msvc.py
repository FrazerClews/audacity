...
"""
    ...
    try:
        try:
            ...
            debug(
                "msvc: get_msvc_version: %r %r %r -> failure"
        ...
        try:
            targets.append(
                (
                    ...
                    (
                        realtarget,
                        conf.get_msvc_version("winphone", version, target, vsvars),
                    ),
                )
            )
                        ...
                        targets.append(
                            (
                                ...
                                (
                                    arch,
                                    conf.get_msvc_version(
                                        "intel", version, target, batch_file
                                    ),
                                ),
                            )
                        )
...
def msvc_common_flags(conf):
    ...
    v["CFLAGS_CRT_MULTITHREADED_DLL_DBG"] = v["CXXFLAGS_CRT_MULTITHREADED_DLL_DBG"] = [
        "/MDd"
    ]
    v["LIB_ST"] = "%s.lib"
